...
func (s *PageHandler) Index(w http.ResponseWriter, r *http.Request) {
...
func (s *PageHandler) PurchasePageView(w http.ResponseWriter, r *http.Request) {
...
func (s *PageHandler) Purchase(w http.ResponseWriter, r *http.Request) {
	db := s.DB
	id := r.FormValue("id")
...
func (s *PageHandler) Result(w http.ResponseWriter, r *http.Request) {
	db := s.DB
...
func main() {
	...
	http.HandleFunc("/", page_handle_func.Index)

	http.HandleFunc("/purchase_page", page_handle_func.PurchasePageView)

	http.HandleFunc("/purchase", page_handle_func.Purchase)

	http.HandleFunc("/result", page_handle_func.Result)
