...
// top page (/)
func (app *App) getAllLotteries(w http.ResponseWriter, r *http.Request) {
...
// purchase_page
func (app *App) purchase_page(w http.ResponseWriter, r *http.Request) {
...
func main() {
	...
	// top page
	http.HandleFunc("/", app.getAllLotteries)

	// purchase_page
	http.HandleFunc("/purchase_page", app.purchase_page)

	// purchase
	http.HandleFunc("/purchase", app.purchase)

	// result
	http.HandleFunc("/result", app.getResult)
