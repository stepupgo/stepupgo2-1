...
// PurchasePage is a handler method for /purchase_page
func (h *handler) PurchasePage(w http.ResponseWriter, r *http.Request) {
...
// Purchase is a handler method for /purchase
...
// Result is a handler method for /result
