...
//RouteHandle は "/"　での Handleメソッド
func (h Handler) RouteHandle(w http.ResponseWriter, r *http.Request) {
...
//PurchasePageHandle は "/purchase_page"　でのHandleメソッド
func (h Handler) PurchasePageHandle(w http.ResponseWriter, r *http.Request) {
...
//PurchaseHandle は "/purchase"　でのHandleメソッド
func (h Handler) PurchaseHandle(w http.ResponseWriter, r *http.Request) {
	id := r.FormValue("id")
...
// ResultHandle は　"/result"　での Handleメソッド
func (h Handler) ResultHandle(w http.ResponseWriter, r *http.Request) {
